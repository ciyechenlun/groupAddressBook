...
<script type="text/javascript" src="/resources/js/sysmanage/company/add.js"></script>
  <div class="openwarp">
   ...
   <input type="hidden" name="pedometerFlag" id="pedometerFlag" value="${pedometerFlag}"/>
       <div class="openbz">
         ...
         <div class="f_l opname"><span></span></div>
       </div>       
       <div class="opentabs">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="t_r">地市：</td>
            <td class="t_l"><input id="city"  name="city"  type="text" class="opcek3" style="width:160px"/></td>
            <td class="t_r">通讯录上限：</td>
            <td class="t_l"><input name="companyUsersLimit"  type="text" class="opcek3" /></td>
          </tr>
          <tr>
            <td class="t_r">联系人：</td>
            <td class="t_l"><input name="contactMan"  type="text" class="opcek3" /></td>
            <td class="t_r"> 使用成员上限：</td>
            <td class="t_l"><input name="usersLimit" id="usersLimit"    type="text" class="opcek3" /></td>
          </tr>
          <tr>
            ...
            <td class="t_l">　
            <input  type="radio" name="otherNetFlag" id="radio" value="0"  />
            	允许　
              　		<input type="radio" name="otherNetFlag" id="radio2" value="1" checked="checked"  />
            	不允许</td>
          </tr>
          <tr>
            <td class="t_r">更换皮肤：</td>
            <td class="t_l"><input id="textfield" name="textfield" readOnly  type="text" class="opcek3" />
   ...
   <div class="opennav pd70">
      ...
      <a href="javascript:void(0)" onClick="addCompany.addCompany()"><div class="f_l opbtns"  ><img src="/resources/images/bc.png" />保　存</div></a>
   </div>