...
<head>
	<base href="<%=basePath%>" />
	<script type="text/javascript" src="/resources/js/sysmanage/dictData/dictData.js"></script>
</head>

<body>
<div class="easyui-layout" data-options="fit:true"> 
    <div data-options="region:'center',border:false,title:'数据字典数据列表'">
    	<div class="easyui-layout" data-options="fit:true">
            <!--start:表格头部button-->
    ...
    <div data-options="title:'数据字典类型列表',region:'west',border:false" style="width:500px;border-right:1px #ccc solid;margin-left:-1px;">
